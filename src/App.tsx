      ...
      {showScrollTop && (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
          ...
          <a
            ...
            className="p-2.5 sm:p-3.5 rounded-full text-white shadow-xl cursor-pointer hover:scale-110 active:scale-95 transition-all flex items-center justify-center backdrop-blur-sm animate-fade-in"
            style={{ 
          ...
          <button
            ...
            style={{ 
              ...
              boxShadow: '0 8px 24px rgba(27, 111, 234, 0.4)'
            }}
